...
```{r install and load libraries, eval = F, echo = F, message = F, warning = F}
...
```{r create arrowfiles, eval=FALSE}
...
```{r Create ArchRProject and filter, eval=FALSE}
proj <- ArchRProject(
...
```{r Dimensionality Reduction, UMAP Generation and Visualization, eval=FALSE}
...
The novelty of singel cell approaches is to be able to resolve cellular heterogenity in complex tissues. We can identify cells populations by a We can try to assign biological labels to the clusters defined in 
