...
```{r Filter doublets ArchRProject, message = F, warning = F, cache = TRUE}
...
```{r Save ArchRProject}
proj <- saveArchRProject(ArchRProj = projHeme2)
```
<br>
```{r Load ArchRProject}
