...
unseq.rna <- sample_log %>% 
  select("Sample", "Cancer Status", "FLCs sequenced with (mRNA)", "Location Sequenced (mRNA)", "mRNA included in Cell Reports") %>% 
  filter_all(any_vars(is.na(.)))
```

```{r import real masses}
real.masses <- read_csv(file = "")
```
